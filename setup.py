...
setup(
    ...
    description='Creating a Differential Privacy securing Synthetic Data Generation for tabular, relational and time series data.',
    extras_require={
        'test': tests_require,
    ...
    name='DPSDV',
    packages=find_packages(include=['DPSDV', 'DPSDV.*']),
